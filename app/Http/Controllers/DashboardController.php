...
class DashboardController extends Controller
{
    ...
    private function adminDashboard()
    {
        ...
        return view('dashboard.admin', compact(
            'stats', 'recentProjects', 'recentUsers', 'announcements',
            'projectsByStatus', 'projectsByCity'
        ));
    }
    ...
    private function volunteerDashboard(User $user)
    {
        ...
        return view('dashboard.volunteer', compact(
            'user', 'profile', 'myProjects', 'myTasks',
            'availableProjects', 'announcements', 'completedCount', 'totalHours', 'points'
        ));
    }
    ...
    private function ownerDashboard(User $user)
    {
        ...
        return view('dashboard.owner', compact(
            'user', 'projects', 'stats', 'recentApplications', 'announcements'
        ));
    }
}