...
.step-num {
    ...
    display: flex; align-items: center; justify-content: center;
    margin: 0 auto 16px; font-family: 'Cairo', sans-serif;
}
...
.stat-strip-num { font-size: 2.8rem; font-weight: 900; font-family: 'Cairo', sans-serif; line-height: 1; }
...
.cta-section::before {
    ...
    font-size: 15rem; opacity: .04; top: -20px; right: -20px;
}
</style>
@endpush
    ...
    <div class="container py-5">
        <div class="row align-items-center g-5">
            <div class="col-lg-6 fade-in-up">
                ...
                <p class="lead mb-32">
                    منصة إلكترونية متكاملة تربط المتطوعين بمشاريع إعادة إعمار المشاريع الصغيرة المتضررة.
                </p>
            ...
            <div class="col-lg-6 hero-visual">
                <div class="position-relative px-4">
                    ...
                    {{-- ✅ هنا الإصلاح: $totalCompleted و $totalVolunteers --}}
                    <div class="floating-stat s1">
                        <div class="stat-icon2" style="background:var(--primary-pale);color:var(--primary);">✅</div>
                        <div>
                            <div style="font-size:1.1rem;font-weight:900;color:var(--primary);">{{ $totalCompleted }}</div>
                    ...
                    <div class="floating-stat s2">
                        ...
                        <div>
                            <div style="font-size:1.1rem;font-weight:900;color:var(--accent);">{{ $totalVolunteers }}</div>
...
<section class="stats-strip">
    <div class="container">
        <div class="row g-4">
            {{-- ✅ هنا الإصلاح: متغيرات مباشرة بدل arrays --}}
            <div class="col-6 col-md-3">
                <div class="stat-strip-item">
                    <div style="font-size:2rem;margin-bottom:4px;">🏗️</div>
                    <div class="stat-strip-num">{{ number_format($totalProjects) }}+</div>
                    <div class="stat-strip-label">مشروع مسجّل</div>
                </div>
            </div>
            <div class="col-6 col-md-3">
                <div class="stat-strip-item">
                    <div style="font-size:2rem;margin-bottom:4px;">🙋</div>
                    <div class="stat-strip-num">{{ number_format($totalVolunteers) }}+</div>
                    <div class="stat-strip-label">متطوع فعّال</div>
                </div>
            </div>
            <div class="col-6 col-md-3">
                <div class="stat-strip-item">
                    <div style="font-size:2rem;margin-bottom:4px;">✅</div>
                    <div class="stat-strip-num">{{ number_format($totalCompleted) }}+</div>
                    <div class="stat-strip-label">مشروع مكتمل</div>
                </div>
            </div>
            <div class="col-6 col-md-3">
                <div class="stat-strip-item">
                    <div style="font-size:2rem;margin-bottom:4px;">🏪</div>
                    <div class="stat-strip-num">{{ number_format($totalOwners) }}+</div>
                    <div class="stat-strip-label">صاحب مشروع</div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row g-4 justify-content-center">
            <div class="col-md-5">
                <a href="{{ route('register') }}" class="role-card volunteer">
                    ...
                    <p style="color:var(--text-mid);font-size:.95rem;margin:12px 0;">
                        قدّم مهاراتك في النجارة، الكهرباء، البناء، وغيرها لمساعدة المتضررين.
                    </p>
            ...
            <div class="col-md-5">
                <a href="{{ route('register') }}" class="role-card owner">
                    ...
                    <p style="color:var(--text-mid);font-size:.95rem;margin:12px 0;">
                        سجّل مشروعك المتضرر واحصل على دعم المتطوعين لإعادة الإعمار بسرعة.
                    </p>
...
<section class="cta-section">
    <div class="container position-relative">
        <h2 style="font-family:'Cairo',sans-serif;font-weight:900;font-size:2.2rem;margin-bottom:16px;">
            ابدأ رحلتك التطوعية اليوم
        </h2>
        <p style="font-size:1.05rem;opacity:.8;max-width:500px;margin:0 auto 32px;">
            انضم لآلاف المتطوعين الذين يُغيّرون حياة الناس ويُعيدون بناء المجتمع حجراً حجراً.
        </p>
        <div class="d-flex gap-3 justify-content-center flex-wrap">
            <a href="{{ route('register') }}" class="btn btn-lg px-5 fw-bold"
               style="background:var(--accent);color:var(--text-dark);border-radius:12px;">
                <i class="bi bi-person-plus me-2"></i>انضم مجاناً
            </a>
            <a href="{{ route('projects.index') }}" class="btn btn-lg btn-outline-light px-5 fw-bold"
